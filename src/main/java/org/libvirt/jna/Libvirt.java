...
public interface Libvirt extends Library {
    ...
    */
    ...
    int virDomainPinVcpuFlags(DomainPointer virDomainPtr, int vcpu, byte[] cpumap, int maplen, int flags);
    ...
    int virDomainSetMemoryFlags(DomainPointer virDomainPtr, NativeLong memory, int flags);
